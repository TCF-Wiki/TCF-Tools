...
<header class="mw-header citizen-header">
	<div class="header-outer">
        <div class="header-item" v-tooltip="{content: 'Official Wiki'}"> 
            <a href="https://thecyclefrontier.wiki/wiki/Main_Page"> 
                <img  src="/wiki_logo_notext.png">
            </a>
        </div>
		<div class="header-item" v-tooltip="{content: 'Home Page'}"> 
            <a href="/"> 
        ...
        <div class="header-item" v-tooltip="{content: 'Interactive Map'}"> 
            <a href="/map.html"> 
        ...
        <div class="header-item" v-tooltip="{content: 'Progress Tracker'}"> 
        ...
        <div class="header-item" v-tooltip="{content: 'Weapon Calculator'}"> 
        ...
        <div class="header-item" v-tooltip="{content: 'Forge Simulator'}"> 
            <a href="/forge.html"> 
        ...
        <div class="header-item" v-tooltip="{content: 'Loadout Generator'}"> 
            <a href="/loadout.html"> 
