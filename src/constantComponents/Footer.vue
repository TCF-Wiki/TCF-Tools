        ...
        <div class="footerExtras">
            <section class="aboutAndSocial">
                ...
                <ul class="footerSocial">
                    ...
                    <li>
                        <a href="https://discord.com/channels/469039260163637249/892772096877400105" target="_blank">
                    ...
                    <li>
                        <a href="https://github.com/TCF-Wiki/TCF-Tools" target="_blank">
            ...
            <section class="links">
                ...
                <ul>
                    <li>
                        <a href="https://about.thecyclefrontier.wiki/" target="_blank">About</a>
                    </li>
                    <li>
                        <a href="https://thecyclefrontier.wiki/wiki/Wiki:Privacy_policy" target="_blank">Privacy Policy</a>
                    </li>
                    <li>
                        <a href="mailto:thecyclefrontierwiki@gmail.com" target="_blank">Contact</a>
                    </li>
                    <li>
                        <a href="https://ko-fi.com/tcfwiki" target="_blank">Donate</a>
                    </li>
                </ul>
            </section>
        </div>
