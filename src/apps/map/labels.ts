...
export const mapOneLabels = [
    mapLabel('Science Campus',  -191.954, 193.220),
    mapLabel('Waterfall Labs', -52.919, 188.220),
    mapLabel('Dig Site', -55.920, 120.699),
    ...
    mapLabel('Comms Tower', -119.742,58.630),
    ...
    mapLabel('Power Plant', -145.880,82.000),
    ...
    mapLabel('Crashed Drill Site', -110.001,167.270),
...
export const mapTwoLabels = [
    ...
    mapLabel('Lagoon Thermal Ponds', -175.945, 118.740)
]
