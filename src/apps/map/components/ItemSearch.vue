...
export default defineComponent({
    ...
    methods: {
        ...
        itemImage(itemName: string): string {
            ...
            if (foundItem?.includes("Map01_KeyCard"))
                return "Bright_Sands_Key_Card";
            if (foundItem?.includes("Map02_KeyCard"))
                return "Crescent_Falls_Key_Card";
            if (foundItem?.includes("Map03_KeyCard"))
                return "Tharis_Island_Key_Card";
            if (foundItem?.includes("Flechette Gun"))
                return "ASP Flechette Gun";
