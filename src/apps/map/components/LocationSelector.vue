<template>
	<section>
		<header>
			<h2>Containers</h2>
			<div @click="enableAllContainers()" aria-label="Enable all container locations" class="enable-all" v-tooltip="{content: 'Enable all', html: true}">
				<font-awesome-icon icon="fa-solid fa-square-check" />
			</div>

			<div @click="disableAllContainers()" aria-label="Disable all container locations" class="disable-all" v-tooltip="{content: 'Disable all', html: true}">
				<font-awesome-icon icon="fa-solid fa-square-xmark" />
			</div>
		</header>
		<div class="button-container">
			<div v-if="mapData" v-for="value in orderedContainers" @click="notFoundContainers.includes(value) ? null : selectedLocations.toggle(value)" :aria-label="'Toggle ' + locationNamer(value)" role="button">
				<div>
	...
	<section>
		<header>
			...
			<div @click="enableAllCreatures()" aria-label="Enable all creature locations" class="enable-all" v-tooltip="{content: 'Enable all', html: true}">
				<font-awesome-icon icon="fa-solid fa-square-check" />
			</div>

			<div @click="disableAllCreatures()" aria-label="Disable all creature locations" class="disable-all" v-tooltip="{content: 'Disable all', html: true}">
				<font-awesome-icon icon="fa-solid fa-square-xmark" />
			</div>
		</header>
		<div class="button-container">
			<div v-if="mapData" v-for="value in orderedCreatures" @click="notFoundCreatures.includes(value) ? null : selectedCreatures.toggle(value)" :aria-label="'Toggle ' + creatureNamer(value)" role="button">
	...
	<section>
		<header>
			...
			<div @click="enableAllSpecial()" aria-label="Enable all special locations" class="enable-all" v-tooltip="{content: 'Enable all', html: true}">
				<font-awesome-icon icon="fa-solid fa-square-check" />
			</div>

			<div @click="disableAllSpecial()" aria-label="Disable all special locations" class="disable-all" v-tooltip="{content: 'Disable all', html: true}">
				<font-awesome-icon icon="fa-solid fa-square-xmark" />
			</div>
		</header>
		<div class="button-container">
			<div v-if="mapData" v-for="value in orderedSpecialLocations" @click="notFoundSpecialLocations.includes(value) ? null : selectedLocations.toggle(value)" :aria-label="'Toggle ' + locationNamer(value)" role="button">
...
<script lang="ts">
	...
	import {locationNames, alphabeticalContainers, alphabeticalSpecialLocations, alphabeticalCreatures} from "../mapConstants";
		...
		methods: {
			...
			disableAllContainers(): void {
				...
				for (let loc in oldLocations) {
					if (this.specialLocations.includes(oldLocations[loc])) {
