    ...
    <section ref="card" class="card" @click="openModal()">
        ...
        <div class="card__button" role="button" @click.stop.prevent="progressInfo.toggle(faction, name)">
            <div class="card__button-text" :class="faction">
                <svg v-if="progressInfo.get()[faction][name] >= missions[faction][name].length" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
...
export default defineComponent({
    props: ["name", "faction", "unlock", "footer"],
    data() {
        return {
            missions: missions,
