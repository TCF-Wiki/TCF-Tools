<template>
    <section class="card" :style="{'--index': zIndex}" @click="isExpanded = true" :class="{expanded: isExpanded}" ref="card">
        <div class="card__image">
            <img :src="'/quest-images/Parts/' + mission + '.png'" :key="index" class="card__image-img" />
        </div>
        <div class="card__contents">
            ...
            <section class="card__tasks">
                ...
                <div v-for="(t, i) in missionData[mission]['objectives']" class="card__tasks-container">
                    <img :src="'/map-images/item-images/' + taskImage(t) + '.png'" class="card__tasks-image" />
                    <div>
            ...
            <section class="card__rewards" :style="{'--length': orderedRewards(missionData[mission]['rewards']).length}">
                <div v-for="r in orderedRewards(missionData[mission]['rewards'])" class="card__rewards-container" v-tooltip="{content: rewardImageNamer(r['item']), html: true}">
                    <img :src="'/map-images/item-images/' + rewardImageNamer(r['item'], true) + '.png'" class="card__rewards-image" />
                    <div>
                        {{ currencyDisplay(r) }}
                    </div>

                    <div class="rewards__info">Test</div>
                </div>
            </section>
